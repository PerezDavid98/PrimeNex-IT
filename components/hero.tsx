    ...
    <section id="top" className="relative pt-28 pb-14 md:pt-40 md:pb-20">
      ...
      <div className="shell relative">
        ...
        <div className="grid12 mt-8 md:mt-12">
          ...
          <nav
            aria-label={a11y.practiceAreas}
            className="col-span-12 mt-12 lg:col-span-3 lg:col-start-10 lg:mt-2 lg:self-end"
          >
            <ul>
              {practiceIndex.map((label, i) => (
                <Reveal as="li" key={label} delay={0.08 * i} y={10}>
                  <a
                    href="#services"
                    className="row group flex min-h-11 items-baseline gap-4 border-t border-rule px-2 py-3.5 last:border-b"
                  >
                    ...
                    <span
                      aria-hidden
                      className="t-num transition-transform duration-300 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:translate-x-1"
                    >
                      →
                    </span>
                  </a>
        ...
        <div className="grid12 mt-14 md:mt-20">
          <Reveal className="col-span-12 lg:col-span-6 lg:col-start-4" delay={0.12}>
