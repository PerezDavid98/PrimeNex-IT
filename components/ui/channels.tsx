...
export function ChannelDock({
  ...
  /* WhatsApp alone. Two stacked buttons covered the right-hand column of the
     ledger at small sizes, and LinkedIn is already reachable in the contact
     list and the footer — this is the channel that needs to follow the
     reader. */
  const channels = [
    {
      key: "whatsapp",
